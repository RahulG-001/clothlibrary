		...
		<div class="carousel-inner">
			...
			?>
				<div class="item <?php if($s==1){echo 'active';}else{ echo '';}?>">
					<img src="admin/lib/image/<?php echo $row['image'];?>"  style="width:100%;">
				</div>
			 <?php $s++; } ?>
...
<div class="banner ab1">
    <div id="carousel-example-generic" class="carousel slide margin10" data-ride="carousel">
        <!-- Wrapper for slides -->
        <div class="carousel-inner" role="listbox">
				<?php 
					...
					foreach($sportfetch as $row){
				?>
					<div class="item item-1 <?php if($s==1){echo 'active';}else{ echo '';}?>">
						<img src="admin/lib/image/<?php echo $row['image1'];?>" width="100%">
					</div>
				<?php $s++; } 
				?>
        </div>
...
<div class="favorite-rooms content-area clearfix">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<h1 class="showroom1"><p class="showroomp3"><i style="font-size:20px; color:#865c5e;" class="fa fa-map-marker" ></i>&nbsp;Shahpur Jat<br><span class="addressshow">5L, First Floor, Dada Jungi House,<br> Lane no.1 New Delhi 110049</span></p></h1>
				<iframe width="100%" height="350px" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=5L%2C%20First%20Floor%2C%20Dada%20Jungi%20House%2C%20Lane%20no.1%20New%20Delhi%20110049&key=AIzaSyCFCk5ZCXwcADaO2_6hZDahVJ0wXQkaTD8"></iframe> 
			</div>
		</div>
	</div>
</div>
