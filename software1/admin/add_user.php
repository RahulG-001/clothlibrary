  ...
  <div id="content_area">
    ...
    <?php
			...
			if (isset($_POST['userid'])){
				...
				$query = "INSERT into re_users (userid, password) VALUES ('$userid', '$password')";
				$result = mysqli_query($con,$query);
				if($result == true){ 
					$status = '<div class="alert alert-success" role="alert"><span class="glyphicon glyphicon-ok"></span> New User has 
					been added successfully.</div>';
				}
			}
		?>
    <?php echo $status; ?> 
