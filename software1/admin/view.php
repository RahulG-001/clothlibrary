  ...
  <div id="content_area">
    ...
    <p> <a href="dashboard.php">
      ...
      <button type="button" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span> Insert New Item</button>
       </a> <a href="import/index.php"><button type="button" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span> Excel Upload</button>
      </a>
		</a> <a href="export.php"><button type="button" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-download"></span> Excel Download</button>
      </a>
      </a> <a href="managelocation.php"><button type="button" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus"></span>Mange Location</button>
      </a>
        ...
        <form class="form-inline" action="filter_print.php" target="_blank">
          <button type="button" onClick='window.open("print.php", "_blank", "toolbar=no,scrollbars=yes,resizable=yes,width=800,height=600")' class="btn btn-sm btn-info"><span class="glyphicon glyphicon-print"></span> Print All Stock</button> | 
			<select class="form-control" name="location">
				<?php
					$sel_query1="SELECT * FROM re_location order by id DESC";
    ...
    <!-- <div class="scrollTbl"> -->
      <table class="table table-striped display" id="stockList">
        <thead>
          <tr>
            <th style="color:rgb(33, 81, 123);">ITEM CODE</th>
            <th style="color:rgb(33, 81, 123);">DESCRIPTION</th>
			<th style="color:rgb(33, 81, 123);">LOCATION</th>
            <th style="color:rgb(33, 81, 123);">WIDTH</th>
            <th style="color:rgb(33, 81, 123);">QUANTITY</th>
            <th style="color:rgb(33, 81, 123);">UNIT</th>
			<th style="color:rgb(33, 81, 123);">PRICE</th>
            <th style="color:rgb(33, 81, 123);">UPDATED ON</th>
            <th style="color:rgb(33, 81, 123);">&nbsp;</th>
            <th style="color:rgb(33, 81, 123);">&nbsp;</th>
          </tr>
        </thead>
        <tbody>
          <?php
			...
			$count=1;
			$sel_query="SELECT * FROM re_indiadata order by id DESC";
			...
			?>
          <tr>
            <td><a href="history.php?itemcode=<?php echo $row["itemcode"]; ?>"><?php echo $row["itemcode"]; ?></a></td>
