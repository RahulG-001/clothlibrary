...
if(isset($_POST['new']) && $_POST['new']==1){ 
   // change time zone to india
	...
	$quantity = $_REQUEST['quantity'].' '.$_REQUEST['unit'];
  ...
  // incase itemid is new
  	...
  	$ins_query="insert into re_indiadata(`trn_date`, `itemcode`,`description`,`location`,`width`,`quantity`,`price`,`country`)values('$trn_date', '$itemcode','$description','$location','$width','$quantity','$price','$country')";
