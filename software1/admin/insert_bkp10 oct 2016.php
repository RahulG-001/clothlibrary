...
if(isset($_POST['new']) && $_POST['new']==1) {
  ...
  $check=mysql_query("select * from re_indiaData where itemcode='$itemcode'") or die(mysql_error());
  ...
  // incase itemid is new
  	...
  	$ins_query="insert into re_indiaData(`trn_date`, `itemcode`,`description`,`width`,`quantity`,`country`)values('$trn_date', '$itemcode','$description','$width','$quantity','$country')";
...
<div id="mainPanel"> 
  ...
  <!-- footer -->
  <div id="footer">
    copyright &copy; 2017 Kalidioscope. 
  </div>
</div>
