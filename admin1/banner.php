...
<script>
	...
	{ 
		$.ajax({
			url: "lib/library.php?action=get_Testimonial",
			type: "GET",
			success: function (data){ //alert(JSON.stringify(data));
				...
				table= $('#Testimonial').DataTable({  
					...
					columns:[
						...
						{ title:"Desktop Image", data: "image" },
						{ title:"Mobile Image", data: "image1" },
	...
	function submitform(){ 
		$("#addform").submit(function(event) { 
			...
			$.ajax({
				url: 'lib/library.php?action=add_Testimonial',
				type:'POST',
	...
	function updateform(){
		$("#editform").submit(function(event) { 		
			...
			event.stopImmediatePropagation();
			$.ajax({
				url: 'lib/library.php?action=edit_Testimonial',
				type:'POST',
				data: new FormData(this),
				cache:false,
				contentType:false,
	...
	function Edit(data){
		$.ajax({
			type:"POST",
			url:"lib/library.php?action=veiw_Testimonial",
			data:{veiw_Testimonial:data},
			success:function(data1)
			{ //alert(JSON.stringify(data1));
				$("#Testimonial_id").val(data1.id);
				$("#start_date").val(data1.start_date);
				$("#name").val(data1.name);
				$("#title").val(data1.title);
				$("#disc").val(data1.disc);
				$("#image").html('<img src="lib/image/'+data1.image+'" hieght="140px" width="240px">');
				$("#image11").html('<img src="lib/image/'+data1.image1+'" hieght="140px" width="240px">');
				//$("#large1").modal("show");
			}
		  });
	}
	function active(data){
		$.ajax({
			type:"POST",
			url:"lib/library.php?action=active_Testimonial",
			data:{active_Testimonial:data},
			success:function(data1)
			{ 
				table.destroy();
				GetAllData();
	...
	function deleteTestimonial(data){
		...
		if(agree){
			$.ajax({
				type:"POST",
				url:"lib/library.php?action=deleteTestimonial",
				data:{deleteTestimonial:data},
				success:function(data1)
				{
				  if(data1==1)
				  {
	...
	<div class="col-md-12">
		...
		<div class="portlet box grey-cascade">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>Banner List
				</div>
				<div class="tools">
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="form-group">
														<p style="color:red;">The width of Banner should be 1920*700 Pixels</p>
												...
												<div class="col-md-6">
													<div class="form-group">
													<p style="color:red;">The width of Banner should be 400*200 Pixels</p>
			...
			<div class="modal fade" id="updateTestimonial" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
