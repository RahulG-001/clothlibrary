...
<script>
	...
	{ 
		$.ajax({
			url: "lib/library.php?action=get_Client",
			type: "GET",
	...
	function submitform(){ 
		$("#addform").submit(function(event) { 
			...
			$.ajax({
				url: 'lib/library.php?action=add_Client',
				type:'POST',
	...
	function updateform(){
		$("#editform").submit(function(event) { 		
			...
			event.stopImmediatePropagation();
			$.ajax({
				url: 'lib/library.php?action=edit_Client',
				type:'POST',
				data: new FormData(this),
				cache:false,
				contentType:false,
	...
	function Edit(data){ 
		$.ajax({ 
			type:"POST",
			url:"lib/library.php?action=veiw_Client",
			data:{veiw_Client:data},
			success:function(data1)
			{ //alert(data1);
				$("#Client_id").val(data1.id);
				$("#Client_image").html('<img src="lib/image/'+data1.image+'" hieght="140px" width="240px">');
				$("#large1").modal("show");
			}
		  });
	}
	function active(data){
		$.ajax({
			type:"POST",
			url:"lib/library.php?action=active_Client",
			data:{active_Client:data},
			success:function(data1)
			{ 
				table.destroy();
				GetAllData();
	...
	function deleteClient(data){
		...
		if(agree){
			$.ajax({
				type:"POST",
				url:"lib/library.php?action=deleteClient",
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet box grey-cascade">
										...
										<div class="row">
											<div class="col-md-9">
												<div class="form-group">
													...
													<p style="color:red;">The width of image should be 375*183px</p>
			...
			<div class="modal fade" id="updateClient" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
