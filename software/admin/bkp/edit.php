...
if(isset($_POST['new']) && $_POST['new']==1) {
  ...
  $stockinward =$_REQUEST['soldtoclients'];
  $stockinward =$_REQUEST['comments'];
	$country = $_REQUEST['country'];
	
	$update="update indiadata set trn_date='".$trn_date."', description='".$description."', width='".$width."', quantity='".$quantity."', country='".$country."' where itemcode='".$itemcode."'";
    ...
    <form class="form-horizontal" name="form" method="post" action="" autocomplete="off">
      ...
      <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="stockinward" class="form-control" placeholder="Enter Stock Inward" disabled value="<?php echo $row['stockinward'];?>" />
            </div>
      </div>
