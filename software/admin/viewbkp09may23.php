 ...
 <div id="logo" style="margin-left:10%; margin-right:10%;text-align:center;"><img src="../images/lc_logo_small.jpg" width="100%" height="80px;" alt="Kalidioscope" />
  ...
  <div id="content_area">
    ...
    <p> <a href="dashboard.php">
      ...
      <div style="border-top:1px solid #ccc; border-bottom:1px solid #ccc; padding:5px 0px 5px 0px">
      
      <div class="row">
        <div class="col-sm-5 col-md-6">
          <div class="row" style="margin-left:10px;">
          <form class="form-inline" action="filter_export.php">
            <div class="input-group">
              <input type="text" class="form-control" id="filterexport" name="filterexport" placeholder="Item ID">
            <span class="input-group-btn">
              <button type="submit" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-download-alt"></span> Filter and Export</button>
            </span>
            </div>
          </form>
          </div>
        ...
        <div class="col-sm-5 col-md-6">
          ...
          <form class="form-inline" action="filter_print.php" target="_blank">
            ...
            <span class="input-group-btn">
              <button type="submit" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-print"></span> Filter and Print</button>
            </span>
            </div>
          </form>
          </div>
