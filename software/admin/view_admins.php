      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="edit_admins.php?userid=<?php echo $row["userid"]; ?>"><span class="glyphicon glyphicon-edit"></span> Change Password</a></td>
            <td><a onclick="return checkDelete()" href="delete_admin.php?userid=<?php echo $row["userid"]; ?>"><span class="glyphicon glyphicon glyphicon-remove"></span> Delete</a></td>
          </tr>
          <?php $count++; } ?>
        </tbody>
      </table>
