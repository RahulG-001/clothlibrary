...
<div id="mainPanel"> 
    ...
    <?php
		...
		if (isset($_POST['userid'])){			
			...
			if($rows==1){
				...
				//header("Location: http://www.cucinello.com/user/view_stock.php"); // Redirect user to index.php
			} else{
  ...
  <!-- footer -->
  <div id="footer"> IA SAN MARCO 6, OCCHIEPPO SUPERIORE (Bi) ITALY<br />
    <div class="copyFtr">copyright &copy; 2000 Lanificio Cucinello.</div>
  </div>
</div>
