...
<script>
	...
	{ 
		$.ajax({
			url: "lib/library.php?action=get_Gallery",
			type: "GET",
			success: function (data){ //alert(JSON.stringify(data));
				...
				table= $('#Gallery').DataTable({
					...
					columns:[ 
						...
						{ title:"Gallery Image", data: "image" },
	...
	function submitform(){ 
		$("#addform").submit(function(event) { 
			...
			$.ajax({
				url: 'lib/library.php?action=add_Gallery',
				type:'POST',
	...
	function updateform(){
		$("#editform").submit(function(event) { 		
			...
			event.stopImmediatePropagation();
			$.ajax({
				url: 'lib/library.php?action=edit_Gallery',
				type:'POST',
				data: new FormData(this),
				cache:false,
				contentType:false,
	...
	function Edit(data){ 
		$.ajax({ 
			type:"POST",
			url:"lib/library.php?action=veiw_Gallery",
			data:{veiw_Gallery:data},
			success:function(data1)
			{ //alert(data1);
				$("#Gallery_id").val(data1.id);
				$("#Gallery_image").html('<img src="lib/image/'+data1.image+'" hieght="140px" width="240px">');
				$("#large1").modal("show");
			}
		  });
	}
	function active(data){
		$.ajax({
			type:"POST",
			url:"lib/library.php?action=active_Gallery",
			data:{active_Gallery:data},
			success:function(data1)
			{ 
				table.destroy();
				GetAllData();
	...
	function deleteGallery(data){
		...
		if(agree){
			$.ajax({
				type:"POST",
				url:"lib/library.php?action=deleteGallery",
				data:{deleteGallery:data},
				success:function(data1)
				{
				  if(data1==1)
				  {
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet box grey-cascade">
			...
			<div class="portlet-body">
				...
				<div id="sample_editable_1_wrapper" class="dataTables_wrapper no-footer">
					...
					<div class="table-scrollable">
						<table class="table table-striped table-bordered table-hover" id="Gallery">
			...
			<div class="modal fade" id="updateGallery" tabindex="-1" role="basic" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title"><b>Update Gallery</b></h4>
						</div>
									...
									<div class="form-body">
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>&nbsp;&nbsp;Gallery Image</label>
													<p style="color:red;">The width of image should be 500*500 Pixels</p>
													<div class="input-group">
														<span id="image1"></span>&nbsp;
