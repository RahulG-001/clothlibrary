  ...
  <div id="content_area">
    ...
    <!-- <div class="scrollTbl"> -->
      ...
      <p style="margin-top:10px" align="right">
        <input name="delete" type="submit" id="delete" value="Delete" class="btn btn-danger" onclick="return checkDelete()">
        <!--<form class="form-inline" action="export_selected_data.php" target="_blank">
          <input name="Export" type="submit" id="Export" value="Export selected" class="btn">
        </form>-->
        <input name="print" type="submit" id="Export" value="Print" onclick="printSelected()" class="btn">
