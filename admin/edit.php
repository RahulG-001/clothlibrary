...
if(isset($_POST['new']) && $_POST['new']==1) {
  ...
  $comments =$_REQUEST['comments'];
	...
	$update="update indiaData set trn_date='".$trn_date."', description='".$description."', stockinward='".$stockinward."', width='".$width."', quantity='".$quantity."', soldtoclients='".$soldtoclients."', comments='".$comments."', country='".$country."' where itemcode='".$itemcode."'";
    ...
    <form class="form-horizontal" name="form" method="post" action="" autocomplete="off">
      ...
      <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="stockinward" class="form-control" placeholder="Enter Stock Inward" value="<?php echo date('d-m-Y',strtotime($row['stockinward'])); ?>" />
            </div>
      </div>
      ...
      <div class="form-group">
            <label for="quantity" class="col-sm-2 control-label">Sold to Clients</label>
            <div class="col-sm-10">
              <input type="text" name="soldtoclients" class="form-control" placeholder="Enter Sold to Clients" required value="<?php echo $row['soldtoclients'];?>" />
            </div>
      </div>
      ...
      <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="comments" class="form-control" placeholder="Enter Comments" required value="<?php echo $row['comments'];?>" />
            </div>
      </div>
